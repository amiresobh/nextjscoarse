    ...
    <div>
      <div className="md:flex">
        <div className="flex flex-wrap space-x-4">
          ...
          <div className="flex justify-start gap-4 shadow-xl rounded-2xl items-center px-2 pb-7 mt-9 w-fit p-5">
            ...
            <div className="flex flex-col gap-2">
              ...
              <p className="text-lg">
                مرکز تخصصی طب کار آیین، در شهر بندرعباس، خیابان سیدجمال الدین واقع شده است.
                جنب کوچه شیرینکده
              </p>
          ...
          <div className="flex justify-start gap-4 shadow-xl rounded-2xl px-2 pb-7 mt-9 w-fit p-5">
            <div className="flex justify-center items-center">
              <ClockSVG />
            </div>
            <div className="flex flex-col gap-2">
