    ...
    <div className="md:flex gap-12">
      <div className="flex flex-col flex-1 justify-center ">
        ...
        <div className="flex flex-col justify-center items-center gap-10 mt-10">
          ...
          <p className="text-xl">
            مرکز تخصصی طب کار آیین، محلی برای ارائه خدمات پزشکی و مشاوره در زمینه
            بهداشت و ایمنی کارکنان است. این مرکز با تیمی مجرب و متخصص، به منظور
            ارائه خدمات بهتر و متناسب با نیازهای شما، همواره در حال به روز رسانی
            و ارتقاء خدمات خود می‌باشد.
          </p>
          <div className="flex flex-col md:flex-row gap-16">
            <div className="flex flex-col gap-2">
              <h3 className="font-EstedadExtraBold text-4xl text-AccentColor">+1000</h3>
              <h3 className="font-EstedadBold">مراجعه کننده</h3>
            </div>
            <div className="flex flex-col gap-2">
              <h3 className="font-EstedadExtraBold text-4xl text-AccentColor">+100</h3>
